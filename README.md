...
You can get your API key by pressing the button on your Hue Bridge and following Hue API instructions.
...
Notes:
- Rapid flashing may strain bulbs; if you notice lag, increase BEAT_INTERVAL slightly.
